...
// ValidateAccessToken implements authcore.TokenValidator.
func (s *JWTService) ValidateAccessToken(tokenStr string) (*authcore.Claims, error) {
	claims := &Claims{}
...
// GenerateRefreshToken returns a random URL-safe string.
